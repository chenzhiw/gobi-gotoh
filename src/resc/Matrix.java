...
public class Matrix {
	 ...
	 */
	public static final int[][] blosum50 = {
			{ 9 },
			{ 0, 14 },
			{ 0, 1, 11 },
			{ 0, -2, 5, 17 },
	...
	public static final int[][] blakeCohen = {
			{ 9 },
			{ 0, 14 },
			{ 0, 1, 11 },
			{ 0, -2, 5, 17 },
	...
	public static final double[][] dayhoff = {
			...
			{ 0.20, -0.00, 2.00 },
			{ 0.30, -1.30, 2.10, 3.90 },
			{ -2.00, -3.60, -3.60, -5.10, 12.00 },
			{ -0.40, 1.20, 0.80, 1.60, -5.30, 4.10 },
			{ 0.30, -1.10, 1.40, 3.40, -5.30, 2.50, 3.90 },
			{ 1.30, -2.60, 0.40, 0.60, -3.30, -1.20, 0.20, 4.80 },
			{ -1.40, 1.50, 1.60, 0.70, -3.40, 2.90, 0.60, -2.10, 6.60 },
			{ -0.50, -2.00, -1.80, -2.40, -2.30, -2.00, -2.00, -2.60, -2.50,
					4.60 },
			{ -1.90, -3.00, -2.90, -4.00, -6.00, -1.80, -3.30, -4.00, -2.10,
					2.40, 6.00 },
			{ -1.20, 3.40, 1.00, 0.10, -5.40, 0.70, -0.10, -1.70, -0.10, -1.90,
					-2.90, 4.70 },
			{ -1.20, -0.50, -1.80, -2.60, -5.20, -1.00, -2.20, -2.80, -2.20,
					2.20, 3.70, 0.40, 6.60 },
			{ -3.50, -4.50, -3.50, -5.60, -4.30, -4.70, -5.40, -4.80, -1.80,
					1.00, 1.80, -5.30, 0.20, 9.10 },
			{ 1.10, -0.20, -0.50, -1.00, -2.70, 0.20, -0.60, -0.50, -0.30,
					-2.00, -2.60, -1.20, -2.10, -4.60, 5.90 },
			{ 1.10, -0.30, 0.70, 0.30, -0.00, -0.50, -0.00, 1.10, -0.80, -1.40,
					-2.80, -0.20, -1.60, -3.20, 0.90, 1.60 },
			{ 1.20, -0.90, 0.40, -0.10, -2.20, -0.80, -0.40, -0.00, -1.30,
					0.10, -1.70, -0.00, -0.60, -3.10, 0.30, 1.30, 2.60 },
			{ -5.60, 2.30, -3.90, -6.60, -7.50, -4.60, -6.80, -6.80, -2.50,
					-5.00, -1.70, -3.30, -4.10, 0.50, -5.50, -2.30, -5.00,
					17.30 },
			{ -3.50, -4.20, -2.10, -4.30, 0.40, -4.00, -4.30, -5.30, -0.10,
					-1.00, -0.90, -4.50, -2.50, 7.00, -5.00, -2.80, -2.80,
					0.00, 10.20 },
			{ 0.20, -2.50, -1.80, -2.20, -1.90, -1.90, -1.80, -1.40, -2.30,
					3.70, 1.80, -2.50, 1.80, -1.20, -1.20, -1.00, 0.30, -6.10,
					-2.50, 4.30 } };
